...
@report_router.post('/reports/list_report', tags=["Reports"], response_model=dict, dependencies=[Depends(JWTBearer())])
@http_decorator
...
@report_router.post('/reports/change_status_report', tags=["Reports"], response_model=dict, dependencies=[Depends(JWTBearer())])
@http_decorator
